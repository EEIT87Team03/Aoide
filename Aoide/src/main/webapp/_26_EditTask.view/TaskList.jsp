...
<head>
  ...
  <link rel="stylesheet" href="/Aoide/template/dist/css/skins/_all-skins.min.css">
...
<!--                 </p> -->
  ...
  <aside class="main-sidebar">
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 613px;"><section class="sidebar" style="height: 613px; overflow: hidden; width: auto;">
      <!-- Sidebar user panel -->
    ...
    </section><div class="slimScrollBar" style="width: 3px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 387.391px; background: rgba(0, 0, 0, 0.2);"></div><div class="slimScrollRail" style="width: 3px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(51, 51, 51);"></div></div>
    <!-- /.sidebar -->
  </aside>
  <!-- sidebar -->
...
<!--  			  			<div class="col-lg-1">.col-lg-1</div> -->
    <div class="box">
								...
								<c:forEach var="aTask" items="${TaskList}">
									<tr id = "${aTask.taskId}">
										...
										<form action="<c:url value ='/DeleteEditTask'/>" method="post">
											<td><button name="taskId" value="${aTask.taskId}"
													type="submit">DETELE</button></td>
										</form>
									</tr>
								</c:forEach>
							</tbody>
						</table>
					<!-- 						<a href="#" onclick="window.open('http://localhost:8080/Aoide/_26_EditTask.view/UploadTask.jsp', '新增', config='height=500,width=400');"><button>新增</button></button新></a> -->
					<!-- 						<a href="#" onclick="window.open('http://localhost:8080/Aoide/_26_EditTask.view/ModifyTask.jsp', '修改', config='height=500,width=400');"><button>修改</button></a> -->
					<!-- 						<br> -->
				</div>
        <!-- /.box-body -->
       ...
       <script>document.getElementById("5").parent.re;</script>
...
<!-- SlimScroll -->
<script src="/Aoide/template//plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
...
<!-- 						<a href="#" -->
<!-- 							onclick="window.open('http://localhost:8080/Aoide/_26_EditTask.view/UploadTask.jsp', '新增', config='height=500,width=400');">新增</a> -->
<%-- 						<td><a href= "<c:url value='/_26_EditTask.view/UploadTask.jsp'/>">Upload</a></td> --%>
<!-- 						<a href="#" -->
<!-- 							onclick="window.open('http://localhost:8080/Aoide/_26_EditTask.view/ModifyTask.jsp', '修改', config='height=500,width=400');">修改</a> -->
<!-- 						<table class="table"> -->
<!-- 							<thead> -->
<!-- 								<tr> -->
<!-- 									<th>No</th> -->
