...
<!-- Bootstrap 3.3.6 -->
<link rel="stylesheet"
	href="/Aoide/template/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet"
...
<!-- Theme style -->
<link rel="stylesheet" href="/Aoide/template/dist/css/AdminLTE.min.css">
<!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
<link rel="stylesheet"
	href="/Aoide/template/dist/css/skins/_all-skins.min.css">
...
<body class="skin-blue fixed sidebar-mini">
	...
	<div class="wrapper">
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img
							...
							alt="User Image"> <!--                 <p> --> <!--                   Alexander Pierce - Web Developer -->
		...
		<div class="slimScrollDiv"
			style="position: relative; overflow: hidden; width: auto; height: 613px;">
			<section class="sidebar"
				style="height: 613px; overflow: hidden; width: auto;"> <!-- Sidebar user panel -->
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview active"><a href="#"> <i
					...
					<ul class="treeview-menu">
						...
						<li class="active"><a href="../layout/fixed.html"><i
								class="fa fa-circle-o"></i> Fixed</a></li>
						<li><a href="collapsed-sidebar.html"><i
			...
			<div class="slimScrollBar"
				style="width: 3px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 387.391px; background: rgba(0, 0, 0, 0.2);"></div>
			<div class="slimScrollRail"
				style="width: 3px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(51, 51, 51);"></div>
		</div>
		<!-- /.sidebar --> </aside>
		...
		<div class="content-wrapper" style="min-height: 612px;">
			...
			<!--         <li><a href="#">Layout</a></li> --> <!--         <li class="active">Fixed</li> -->
			<!--       </ol> --> </section>
			...
			<div class="box">
							...
							<c:forEach var="aBullet" items="${BulletList}">
								<tr>
									...
									<form action="<c:url value ='/DeleteEditBullet'/>"method="post">
										<td><button name="deleteBullet"
												value="${aBullet.bulletId}" type="submit" id="myList"
									...
									<a href="#"
										...
										<button name="ModiftBullet01" value="${aBullet.bulletId}"
				...
				<div class="box-footer">
					<a href="#"
						onclick="window.open('http://localhost:8080/Aoide/_24_EditBullet.view/Uploadbullet.jsp', '新增', config='height=500,width=400');"><button>新增</button></a>
					<!-- 					<a href="#" -->
					<!-- 						onclick="window.open('http://localhost:8080/Aoide/_24_EditBullet.view/ModifyBullet.jsp', '修改', config='height=500,width=400');"><button>修改</button></a> -->
					<br>
				</div>
				<!-- /.box-footer-->
			</div>
			...
			<script>
				document.getElementById("5").parent.re;
			</script>
					...
					<div>
						...
						<div class="form-group">
							<label class="control-sidebar-subheading"><input
								...
								checked="checked"> Fixed layout</label>
       ...
       immediately after the control sidebar -->
		...
		<!-- Bootstrap 3.3.6 -->
		<script src="/Aoide/template//bootstrap/js/bootstrap.min.js"></script>
		<!-- SlimScroll -->
		<script
			src="/Aoide/template//plugins/slimScroll/jquery.slimscroll.min.js"></script>
		<!-- FastClick -->
		<script src="/Aoide/template//plugins/fastclick/fastclick.js"></script>
		<!-- AdminLTE App -->
		<script src="/Aoide/template//dist/js/app.min.js"></script>
		<!-- AdminLTE for demo purposes -->
		<script src="/Aoide/template//dist/js/demo.js"></script>
		<!-- body_library -->
</body>
</html>
...
<!--                     <a href="#" onclick="window.open('http://localhost:8080/Aoide/_24_EditBullet.view/Uploadbullet.jsp', '新增', config='height=500,width=400');">新增</a> -->
<%-- <%--     				<td><a href= "<c:url value='/_24_EditBullet.view\Uploadbullet.jsp'/>">Upload</a></td> --%>
<!--     				<a href="#" onclick="window.open('http://localhost:8080/Aoide/_24_EditBullet.view/ModifyBullet.jsp', '修改', config='height=500,width=400');">修改</a> -->
...
<%-- 			    						<td>${aBullet.contentFile}</td> --%>
<%-- 			    					<form action="<c:url value ='/DeleteEditBullet'/>" method="post"> --%>
<%-- 			    					<td><button name="deleteBullet" value="${aBullet.bulletId}" type="submit">DETELE</button></td> --%>
<!-- 			    					</form>	 -->
<%-- <%-- 			    					<form action="<c:url value ='/ModifyBullet.jsp'/>" method="post"> --%>
<%-- <%-- 			    					<td><button name="taskId" value="${aBullet.bulletId}" type="submit">Modify</button></td> --%>
<!-- 			    					</tr> -->
<%-- 		    					</c:forEach> --%>
<!-- 		    					<tr> -->
<!-- 		    					</tr> -->
