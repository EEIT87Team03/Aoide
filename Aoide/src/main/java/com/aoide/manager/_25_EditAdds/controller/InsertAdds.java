...
public class InsertAdds extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		final Part part = request.getPart("adImg");
		final String AdImgName = getFileName(part).trim();
		int index = AdImgName.lastIndexOf('.');
		String fileNameExtension = AdImgName.substring(index); // get.jpg
		...
		//adVO.setAdImg("/Aoide/files/ad_img_files/Songid10.jpg");
		int id = service.insert(adVO);

		String newAdImgname = "AdImgid" + id + fileNameExtension;
		...
		adVO.setSongId(id);
		String srcPath ="/Aoide/files/ad_img_files/" + newAdImgname;
